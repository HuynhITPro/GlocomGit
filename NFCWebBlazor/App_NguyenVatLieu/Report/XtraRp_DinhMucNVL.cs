...
{
    public partial class XtraRp_DinhMucNVL : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraRp_DinhMucNVL()
        {
            InitializeComponent();
        }
        ...
        private void xrTableCell1_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            //Nếu để dấu tiếng việt ở chỗ mã màu thì bị lỗi không xuất được PDF, cái này cũng không hiểu tại sao
            xrTableCell1.Text= StaticClass.RemoveVietnamese(xrTableCell1.Text).ToUpper();
        }
